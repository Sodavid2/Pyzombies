...
fight(enemy_pool=[zombie, rotten_zombie])
clear_console()
...
fight(enemy_pool=[zombie, runner])
clear_console()
...
fight(enemy_pool=[zombie, runner, rotten_zombie])
clear_console()
get_item(berries)
story_pause()
pass_time(60)
...
fight(enemy_pool=[zombie, big_zombie])
clear_console()
...
fight(enemy_pool=[slender_zombie])
clear_console()
myprint("You kill the zombie but you can hear more are coming.")
fight(enemy_pool=[runner, runner, sprinter])
clear_console()
...
fight(enemy_pool=[armored_zombie, spitter])
clear_console()
...
fight(enemy_pool=[big_zombie, armored_zombie, spitter, runner])
clear_console()
...
fight(enemy_pool=[zombie, spitter, sprinter, giant_zombie])
