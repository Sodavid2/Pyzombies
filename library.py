...
town_weight = (10, 4, 4)
town = Location("town", 12, town_buildings, town_weight)

forest_buildings = [meadow, abondomed_house, house]
forest_weight = [10, 4, 2]
forest = Location("forest", 6, forest_buildings, forest_weight)
...
test_world_locations = [forest, town]
test_world_weights = [10, 6]
